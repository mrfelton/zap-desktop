                ...
                edges: [
                  {
                    node: {
                      fields: {
                        slug: '/blog/2018-10-01--welcoming/'
                      }
                    }
                  },
                  {
                    node: {
                      fields: {
                        slug: '/blog/2018-10-02--article-1/'
                      }
                    }
                  },
                  {
              ...
              posts: {
                edges: [
                  ...
                  },
                  {
                    node: {
                      fields: {
                        slug: '/blog/2018-10-02--article-0/'
                      },
                      frontmatter: {
                        tags: null
                      }
    ...
    describe('pagination', () => {
      const generateData = n => {
        const edges = [...Array(n)].map((val, i) => ({
          node: {
            fields: {
              slug: `/blog/2018-10-01--article-${i + 1}/`
            }
          }
        }));
  ...
  describe('onCreateNode', () => {
    ...
    it('should create slugs for MarkdownRemark file', () => {
      getNode.mockReturnValue(
        {
          relativePath: 'blog/2018-10-01--welcoming/index.md'
        }
      );
      const node = {
        internal: {
